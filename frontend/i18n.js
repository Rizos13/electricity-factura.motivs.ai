const I18N_DICT = {
  es: {
    ...
    quality_medium_title: "Datos clave incompletos",
    quality_medium_body: "Tu factura no incluye el consumo en kWh por período. Sin esos datos no podemos calcular un ahorro fiable, así que mostramos el catálogo CNMC solo como referencia. Pide a tu comercializadora una factura detallada o sube una con desglose de consumo para una recomendación real.",
    competitive_title: "Tu tarifa actual ya es competitiva",
    competitive_body: "Hemos comparado tu factura con todo el catálogo CNMC y ninguna oferta del mercado libre te haría ahorrar. Tu tarifa actual está bien posicionada, no merece la pena cambiar ahora. El listado completo queda abajo por si quieres ver las alternativas.",
    ...
    hosted_banner: "Demo hospedada, tu factura se procesa unos segundos en nuestro servidor y se descarta. Para privacidad total, instálalo en tu Mac.",
    hosted_banner_cta: "Instalar local",
  ...
  en: {
    ...
    quality_medium_title: "Key data missing",
    quality_medium_body: "Your bill doesn't include the kWh consumption per period. Without those values we can't compute a reliable saving, so we only show the CNMC catalogue as reference. Ask your retailer for a detailed bill, or upload one with the consumption breakdown for a real recommendation.",
    competitive_title: "Your current tariff is already competitive",
    competitive_body: "We compared your bill against the entire CNMC catalogue and no free-market offer would save you money. Your current tariff is well positioned, switching isn't worth it right now. The full listing is still below if you want to explore the alternatives.",
    ...
    hosted_banner: "Hosted demo, your bill is processed briefly on our server and discarded. For full privacy, install it on your Mac.",
    hosted_banner_cta: "Install local",
