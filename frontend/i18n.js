const I18N_DICT = {
  es: {
    ...
    rec_calc_h_bill: "Tu factura",
    rec_calc_h_kwh: "Tu consumo anual",
    rec_calc_h_plan: "Coste del plan para tu consumo",
    rec_calc_h_save: "Tu ahorro",
    rec_calc_cnmc_ref: "Referencia CNMC",
    rec_calc_scaled_to: "Escalado a tu consumo",
    rec_calc_disclaimer: "Precios CNMC orientativos, sin promociones temporales ni regalos.",
  ...
  en: {
    ...
    rec_calc_h_bill: "Your bill",
    rec_calc_h_kwh: "Your annual usage",
    rec_calc_h_plan: "Plan cost at your usage",
    rec_calc_h_save: "Your savings",
    rec_calc_cnmc_ref: "CNMC reference",
    rec_calc_scaled_to: "Scaled to your usage",
    rec_calc_disclaimer: "CNMC reference prices, no temporary promos or sign-up gifts.",
